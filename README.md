...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cidaonline)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cidaonline
```

A live public deployment of this template is available at [https://cidaonline.templates.workers.dev](https://cidaonline.templates.workers.dev)
